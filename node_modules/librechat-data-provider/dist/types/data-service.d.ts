...
export declare const listSharedLinks: (params?: q.SharedLinkListParams) => Promise<q.SharedLinksResponse>;
export declare function getSharedLink(shareId: string): Promise<t.TSharedLinkResponse>;
export declare function createSharedLink(payload: t.TSharedLinkRequest): Promise<t.TSharedLinkResponse>;
export declare function updateSharedLink(payload: t.TSharedLinkRequest): Promise<t.TSharedLinkResponse>;
export declare function deleteSharedLink(shareId: string): Promise<t.TDeleteSharedLinkResponse>;
...
export declare function updatePromptPermissions(variables: m.UpdatePromptPermVars): Promise<m.UpdatePromptPermResponse>;

...
import { Assistant, AssistantCreateParams, AssistantUpdateParams, ActionMetadata, FunctionTool, AssistantDocument, Action, Agent, AgentCreateParams, AgentUpdateParams } from './assistants';
...
export type DeleteSharedLinkOptions = MutationOptions<types.TSharedLink, {
    shareId: string;
}>;
...
export type UpdatePromptPermOptions = MutationOptions<UpdatePromptPermResponse, UpdatePromptPermVars, unknown, types.TError>;
